...
?>
    <form method="post" action="">
                    ...
                    <td>
                        <input type="text" name="menu_Name" title = "ชื่อเมนูอาหาร 50 ตัวอักษร" value="<?php echo $row['menu_Name'];?>" /*pattern=""*/ required />
                    </td>
                    ...
                    <td>
                        <input type="number" name="menu_price" title="เลขจำนวนเต็มไม่เกิน 4 หลัก" value="<?php echo $row['menu_price'];?>" pattern="[0-9]{4}" required>
                    </td> 
                </tr>    
            </table>  <br>
...
<?php
        ...
        $upd = " UPDATE menu SET menu_Name = '$nameupd', menu_Type = '$sexupd', 
        menu_price = '$ageupd'  WHERE menu_ID = '$idupd'";
